...
proc create_root_design { parentCell } {
  ...
  # Create instance: AXIS2VGA_IP_0, and set properties
  set AXIS2VGA_IP_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:AXIS2VGA_IP:1.0 AXIS2VGA_IP_0 ]

  # Create instance: DOG2AXIS_0, and set properties
  set DOG2AXIS_0 [ create_bd_cell -type ip -vlnv user.org:user:DOG2AXIS:1.3 DOG2AXIS_0 ]
  ...
  connect_bd_intf_net -intf_net DOG2AXIS_0_AXIS_M [get_bd_intf_pins AXIS2VGA_IP_0/AXIS_S] [get_bd_intf_pins DOG2AXIS_0/AXIS_M]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins DOG2AXIS_0/AXIS_S] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
  ...
  connect_bd_net -net AXIS2VGA_IP_0_vga_blue [get_bd_ports vga_blue_0] [get_bd_pins AXIS2VGA_IP_0/vga_blue]
  connect_bd_net -net AXIS2VGA_IP_0_vga_green [get_bd_ports vga_green_0] [get_bd_pins AXIS2VGA_IP_0/vga_green]
  connect_bd_net -net AXIS2VGA_IP_0_vga_hsync [get_bd_ports vga_hsync_0] [get_bd_pins AXIS2VGA_IP_0/vga_hsync]
  connect_bd_net -net AXIS2VGA_IP_0_vga_red [get_bd_ports vga_red_0] [get_bd_pins AXIS2VGA_IP_0/vga_red]
  connect_bd_net -net AXIS2VGA_IP_0_vga_vsync [get_bd_ports vga_vsync_0] [get_bd_pins AXIS2VGA_IP_0/vga_vsync]
  connect_bd_net -net DOG2AXIS_0_int_r [get_bd_pins DOG2AXIS_0/int_r] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axis_data_fifo_0_axis_rd_data_count [get_bd_pins DOG2AXIS_0/fifo_data_c] [get_bd_pins axis_data_fifo_0/axis_rd_data_count]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins AXIS2VGA_IP_0/clk] [get_bd_pins DOG2AXIS_0/clk] [get_bd_pins axis_data_fifo_0/m_axis_aclk] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins AXIS2VGA_IP_0/reset_n] [get_bd_pins DOG2AXIS_0/reset_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins AXIS2VGA_IP_0/fifo_data_c] [get_bd_pins xlconstant_0/dout]
